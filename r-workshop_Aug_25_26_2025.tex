...
\date{August 25$^\text{th}$ and $26^\text{th}$, 2025}
	...
	\begin{overprint}
		\visible<1->{
			\begin{center}
				\begin{figure}
					\scalebox{0.50}{
						\includegraphics[scale=0.9]{./figures/EffortVsCode2}
					}
...
\begin{frame}
	...
	\begin{overprint}
		...
		\onslide<2->{
			\begin{itemize}
				\item With the advent of AI through Large Language Models (LLMs) 
...
\begin{frame}
	...
	\end{itemize}
	\vspace{1cm}
	{\footnotesize \textcolor{blue}{Evolving and modern tooling ecosystem: Posit Cloud, RPubs, Github}}\\	
